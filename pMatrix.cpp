		...
		for (k = 0; k < n; k++)
 		{
 			...
 			for (i = 0; i < n; i++)
 			{
				...
				//if ((k> n-i-1) || (k<i)) printf("%5i", A[k][i]);	                   // - 17 
				//if ((k< n-i-1) || (k> i)) printf("%5i", A[k][i]);	                   // - 18
				...
				//if ((k>n/2)+(i<n/2)&&(i>n/2)+(k<n/2)) printf("%5i", A[k][i]);	       // - 28 
				//if (k>n/2+i|| k<n/2-i-1|| i>=n/2) printf("%5i", A[k][i]);		       // - 29

				//if ((i>k+n/2 || i<n/2-k-1)||k >= n / 2) printf("%5i", A[k][i]);	   // - 31

				//if ((k>n-i-1) || (k >i) && (k>n/2)) printf("%5i", A[k][i]);	       // - 33
				//if ( (k > i) && (k > n/2)) printf("%5i", A[k][i]);	               // - 34
				//if ((k>n/2) && (k>n-i-1) || (k>i)) printf("%5i", A[k][i]);	       // - 35
